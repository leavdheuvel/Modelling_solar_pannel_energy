    ...
    if tab == 'Titelblad':
        return html.Div([
            ...
            html.Div([
                ...
                html.P('Nadat alle bewerkingen voltooid zijn, zijn er verschillende modellen gemaakt. Er is begonnen met een model met alleen de terugelevering van de zonne-energie als de te verklare variabele. Vervolgens is deze stapje voor stapje uitgebreid door middel van verschillende extra voorspellende variabelen toe te voegen, het seizoenscomponent te modelleren en een transformatie uit te voeren op de teruglevering van de zonne-energie. Door alle modellen te vergelijken is uiteindelijk het beste voorspelmodel gekozen.'),
                html.B('De datasets:'),
