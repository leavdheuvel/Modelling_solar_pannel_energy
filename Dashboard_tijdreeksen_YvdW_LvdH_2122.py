...
def render_content(tab):
    if tab == 'Titelblad':
        return html.Div([
            ...
            html.Div([
                html.B('De opdracht:'),
                html.P('Steeds meer huishoudens stappen over naar zonnepanelen, dit komt doordat duurzame energie tegenwoordig enorm in is. Daarnaast is er de mogelijkheid om de energie die opgewekt wordt via de zonnepanelen terug te leveren aan het energienetwerk. Maar hoe zit het met de de hoeveelheid energie die wordt opgewekt als de zon niet of nauwelijks schijnt. Om hier een beter inzicht te krijgen is dan ook de vraag om een voorspellingsmodel te maken dat één week vooruit voorspelt wat het energieverbruik is door zonnepanelen.'),
                html.B('De werkwijze:'),
                ...
                html.P('Nadat alle bewerkingen voltooid zijn, zijn er verschillende modellen gemaakt. Er is begonnen met een model met alleen de terugelevering van de zonne-energie als de te verklare variabele. Vervolgens is deze stapje voor stapje uitgebreid door middel van verschillende extra voorspellende variabelen toe te voegen, het seizoenscomponent te modelleren en een transformatie uit te voeren op de teruglevering van de zonne-energie. Door alle modellen uit te vergelijken is uiteindelijk het beste voorspelmodel gekozen.'),
                html.B('De datasets:'),
